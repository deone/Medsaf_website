    ...
    <>
        ...
        <div className="m-waitlist">
          <div className="m-waitlist-formsec">
            ...
            <div className="m-waitlist-form">
              <iframe
                src="https://docs.google.com/forms/d/e/1FAIpQLSctoeURWAvTeTT2CdBZ-yTyOQbyHSK_KrAcPmHPLWlxAqg89g/viewform?embedded=true"
                width="100%"
                height="800"
                frameBorder="0"
                marginHeight={0}
            ...
            <button
              ...
              className="m-waitlist-payment-btn"
            >
              Continue to payment
            </button>
          </div>
      ...
      >
        <Modal.Body>
          ...
          {plan === "300,000" && (
            <a rel="noopener noreferrer" target="_blank" href="https://paystack.com/pay/xghvuh-ysk">
              <button onClick={submitPlan}>Submit</button>
            </a>
          )}
          {plan === "600,000" && (
            <a rel="noopener noreferrer" target="_blank" href="https://paystack.com/pay/d7qn8pgu8i">
              <button onClick={submitPlan}>Submit</button>
            </a>
          )}
        </Modal.Body>
